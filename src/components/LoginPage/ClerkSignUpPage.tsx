      ...
      <SignUpLayout>
        <BrandSide aria-hidden="true">
          ...
          <BrandContent>
            ...
            <BrandTitle>
              Créez votre<br />
              <Accent>espace</Accent> client.
            </BrandTitle>
            <BrandText>
              Centralisez vos demandes et vos devis, et confiez vos démarches
              administratives, fiscales et juridiques à nos experts au Gabon.
            </BrandText>
          </BrandContent>
        </BrandSide>
